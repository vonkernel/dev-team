...
# ─────────────────────────────────────────────────────────────────────────────
# Internal — message-aware buffer
# ─────────────────────────────────────────────────────────────────────────────


class _ChatEventBuffer:
    """message-aware ChatEvent 버퍼.

    내부 = `deque[ChatEvent]`. send 는 non-blocking — 새 message 시작 시 backlog
    (distinct message_id 개수) 가 max_messages 초과면 oldest message 의 모든
    chunks 통째 drop. partial message 안 남음.
