...
```
1. mcp/document-db/migrations/NNN_<name>.sql        새 마이그레이션 (forward + .rollback.sql)
...
4. src/document_db_mcp/tools/<name>.py              MCP tool 함수 (6 op + 특수 도구) — Pydantic 파라미터 직접 사용 (mcp/CLAUDE.md §1.3.1)
5. src/document_db_mcp/tools/__init__.py            import 1줄 추가
```
